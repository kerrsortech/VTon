...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `/* Base styles for Closelook Try-On Widget */
.closelook-widget-shopify {
...
.closelook-widget-shopify,
.closelook-widget-shopify *,
.closelook-widget-shopify *::before,
.closelook-widget-shopify *::after {
...
function CloselookProvider({ children, config = {} }) {
    const [tryOnResults, setTryOnResults] = (0,node_modules_react.useState)(new Map());
...
const server_logger_logger = new ServerLogger();
/**
 * Sanitizes error responses before sending to client
 */
function sanitizeErrorForClient(error, requestId) {
    const errorDetails = error instanceof Error ? error.message : String(error);
    const sanitizedDetails = server_logger_logger.sanitizeMessage(errorDetails);
...
;// ../../components/closelook-widget.tsx
"use client";




function CloselookWidget({ product, onTryOnComplete, className }) {
    const [isGenerating, setIsGenerating] = (0,node_modules_react.useState)(false);
    const [error, setError] = (0,node_modules_react.useState)(null);
    const [showUploadDialog, setShowUploadDialog] = (0,node_modules_react.useState)(false);
    const [fullBodyFile, setFullBodyFile] = (0,node_modules_react.useState)(null);
    const [halfBodyFile, setHalfBodyFile] = (0,node_modules_react.useState)(null);
    ...
    const [isLoadingImages, setIsLoadingImages] = (0,node_modules_react.useState)(false);
    ...
    return (node_modules_react.createElement(node_modules_react.Fragment, null, showUploadDialog && (node_modules_react.createElement("div", { className: "fixed inset-0 bg-black/50 backdrop-blur-sm z-40 flex items-center justify-center p-4" },
        node_modules_react.createElement("div", { className: "bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto p-6" },
            node_modules_react.createElement("div", { className: "flex items-center justify-between mb-3" },
                node_modules_react.createElement("h2", { className: "text-2xl font-bold" }, "Let's Find Your Perfect Fit"),
                node_modules_react.createElement("button", { onClick: handleCloseDialog, className: "p-2 hover:bg-gray-100 rounded-full transition-colors" },
                    node_modules_react.createElement(X, { className: "h-5 w-5" }))),
            node_modules_react.createElement("p", { className: "text-sm text-gray-600 mb-4" }, "Upload a photo to see products styled on you. We'll show you exactly how each item looks before you buy."),
            node_modules_react.createElement("div", { className: "grid grid-cols-2 gap-4 mb-5" },
                node_modules_react.createElement("div", { className: "space-y-2.5" },
                    node_modules_react.createElement("label", { className: "text-sm font-medium text-gray-700 text-center block mb-1" }, "Standing Photo"),
                    node_modules_react.createElement("div", { className: "border-2 border-dashed border-gray-300 rounded-lg p-5 hover:border-blue-500 transition-colors min-h-[180px] flex items-center justify-center" },
                        node_modules_react.createElement("label", { className: "block cursor-pointer w-full h-full" },
                            node_modules_react.createElement("input", { ref: fullBodyInputRef, type: "file", accept: "image/*", onChange: handleFullBodySelect, className: "hidden" }),
                            node_modules_react.createElement("div", { className: "text-center" }, userImages.fullBodyUrl ? (node_modules_react.createElement("div", { className: "space-y-3" },
                                node_modules_react.createElement("img", { src: userImages.fullBodyUrl, alt: "Standing photo", className: "w-full h-40 mx-auto object-cover rounded-lg" }),
                                node_modules_react.createElement("p", { className: "text-xs font-medium text-green-600" }, "\u2713 Photo uploaded"))) : (node_modules_react.createElement("div", { className: "space-y-3" },
                                node_modules_react.createElement(Upload, { className: "h-10 w-10 mx-auto text-gray-400" }),
                                node_modules_react.createElement("p", { className: "text-sm text-gray-600" }, "Click to upload or drag and drop")))))),
                    node_modules_react.createElement("p", { className: "text-xs text-gray-500 text-center mt-1.5" }, "Full-length photo for dresses, pants & full outfits. Stand naturally with good lighting.")),
                node_modules_react.createElement("div", { className: "space-y-2.5" },
                    node_modules_react.createElement("label", { className: "text-sm font-medium text-gray-700 text-center block mb-1" }, "Portrait Photo"),
                    node_modules_react.createElement("div", { className: "border-2 border-dashed border-gray-300 rounded-lg p-5 hover:border-blue-500 transition-colors min-h-[180px] flex items-center justify-center" },
                        node_modules_react.createElement("label", { className: "block cursor-pointer w-full h-full" },
                            node_modules_react.createElement("input", { ref: halfBodyInputRef, type: "file", accept: "image/*", onChange: handleHalfBodySelect, className: "hidden" }),
                            node_modules_react.createElement("div", { className: "text-center" }, userImages.halfBodyUrl ? (node_modules_react.createElement("div", { className: "space-y-3" },
                                node_modules_react.createElement("img", { src: userImages.halfBodyUrl, alt: "Portrait photo", className: "w-full h-40 mx-auto object-cover rounded-lg" }),
                                node_modules_react.createElement("p", { className: "text-xs font-medium text-green-600" }, "\u2713 Photo uploaded"))) : (node_modules_react.createElement("div", { className: "space-y-3" },
                                node_modules_react.createElement(Upload, { className: "h-10 w-10 mx-auto text-gray-400" }),
                                node_modules_react.createElement("p", { className: "text-sm text-gray-600" }, "Click to upload or drag and drop")))))),
                    node_modules_react.createElement("p", { className: "text-xs text-gray-500 text-center mt-1.5" }, "Waist-up photo for tops, accessories & jewelry. Face clearly visible works best."))),
            node_modules_react.createElement("div", { className: "mb-5 p-3.5 bg-gray-50 rounded-lg border border-gray-200" },
                node_modules_react.createElement("div", { className: "flex items-start gap-3" },
                    node_modules_react.createElement(Lock, { className: "h-4 w-4 text-gray-600 mt-0.5 flex-shrink-0" }),
                    node_modules_react.createElement("p", { className: "text-xs text-gray-600 leading-relaxed" }, "Your privacy matters. Photos are encrypted, never shared, and only visible to you. We never use your images for AI training or any other purpose."))),
            node_modules_react.createElement("div", { className: "flex gap-3 mt-1" },
                node_modules_react.createElement("button", { onClick: handleCloseDialog, className: "flex-1 px-4 py-2.5 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors" }, "Cancel"),
                node_modules_react.createElement("button", { onClick: () => {
                        handleCloseDialog();
                        if (hasUploadedImages) {
                            handleTryOn();
                        }
                    }, disabled: !hasUploadedImages, className: "flex-1 px-4 py-2.5 bg-gray-800 text-white rounded-lg hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors" }, "Save")))))));
}
...
function init(config) {
    ...
    root.render(react.createElement(CloselookProvider, null,
        react.createElement(CloselookWidget, { product: closelookProduct, onTryOnComplete: (result) => {
                console.log("Try-on complete:", result);
                // Optionally dispatch a custom event
                window.dispatchEvent(new CustomEvent("closelook:try-on-complete", {
...
window.CloselookTryOnWidget = __webpack_exports__;
/******/ })()
;